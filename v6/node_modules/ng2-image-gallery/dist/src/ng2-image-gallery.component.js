...
__decorate([
    Input()
], Ng2ImageGalleryComponent.prototype, "images", void 0);
__decorate([
    Input('draggable')
], Ng2ImageGalleryComponent.prototype, "draggable", void 0);
__decorate([
    Input('asImage')
], Ng2ImageGalleryComponent.prototype, "asImage", void 0);
__decorate([
    Input('asThumbnail')
], Ng2ImageGalleryComponent.prototype, "asThumbnail", void 0);
__decorate([
    Input('asText')
], Ng2ImageGalleryComponent.prototype, "asText", void 0);
__decorate([
    Input('actionText')
], Ng2ImageGalleryComponent.prototype, "actionText", void 0);
__decorate([
    Output('onAction')
], Ng2ImageGalleryComponent.prototype, "actionEmitter", void 0);
__decorate([
    Output('onDrop')
], Ng2ImageGalleryComponent.prototype, "dropEmitter", void 0);
Ng2ImageGalleryComponent = __decorate([
    Component({
    ...
    __param(0, Inject(forwardRef(function () { return DragulaService; })))
