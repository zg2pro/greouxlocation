...
export { Directive, Component, NgModule, Attr, Input, Output, HostBinding, HostListener, ViewChild, ViewChildren, ContentChild, ContentChildren } from './src/core/directives';
