...
export declare type RouteConfig = RouteDefinition[];
...
export declare type LegacyDirectiveDefinition = {
...
export declare class DirectiveMetadata extends InjectableMetadata {
    ...
    /**
     * Optional settings from Angular 1 Directive definition object API
     */
    legacy: LegacyDirectiveDefinition;
    constructor({selector, inputs, attrs, outputs, host, providers, exportAs, queries, legacy}?: {
        selector?: string;
        inputs?: string[];
        attrs?: string[];
        outputs?: string[];
...
export declare class ComponentMetadata extends DirectiveMetadata {
    ...
    styleUrls: string[];
    styles: string[];
    constructor({selector, inputs, attrs, outputs, host, exportAs, moduleId, providers, viewProviders, changeDetection, queries, templateUrl, template, styleUrls, styles, legacy}?: {
        selector?: string;
        inputs?: string[];
        attrs?: string[];
        outputs?: string[];
 ...
 *
 */
export declare class AttrMetadata {
    bindingPropertyName: string;
    /**
     *
     * @param {string?} bindingPropertyName Name used when instantiating a component in the template.
