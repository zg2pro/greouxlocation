...
//compute
        ...
        function check_day($current_date) {
            ...
            $connect_chain = "host=localhost dbname=greouxlocation user=greouxlocation password=" . $dbPassword;
            $dbconn = pg_connect($connect_chain)
                    or die('Connexion impossible : ' . pg_last_error());
            $query = "SELECT count(*) as nb FROM bookings WHERE " . $current_date . " >= check_in AND "
