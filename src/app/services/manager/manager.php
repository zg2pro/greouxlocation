...
$dbconn = pg_connect("host=localhost dbname=greouxlocation user=greouxlocation password=xxxxx")
    or die('Connexion impossible : ' . pg_last_error());
...
$dbconn = pg_connect("host=localhost dbname=greouxlocation user=greouxlocation password=xxxxxx")
    or die('Connexion impossible : ' . pg_last_error());
